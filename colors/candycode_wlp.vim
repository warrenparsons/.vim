" Vim color file -- candycode_wlp
" Maintainer:  Warren Parsons 
" Last Change:  2012 June 29 

set background=dark
highlight clear
let g:colors_name="candycode_wlp"
...
hi Normal       guifg=#ffffff       guibg=#10212b       gui=NONE
...
hi CursorLine   guifg=NONE          guibg=#273740       gui=NONE
...
hi ModeMsg      guifg=#eecc18       guibg=NONE          gui=NONE
            \   ctermfg=yellow      ctermbg=NONE        cterm=NONE
hi Title        guifg=#ff5552       guibg=NONE          gui=bold
...
"
" yellow fg, darker yellow bg
hi Comment      guifg=#ffde1d       guibg=#4e532d		gui=NONE
            \   ctermfg=brown       ctermbg=NONE        cterm=NONE
" orange
hi Constant     guifg=#ffbb61       guibg=NONE          gui=NONE
            \   ctermfg=red         ctermbg=NONE        cterm=NONE
hi Boolean      guifg=#ff6050       guibg=NONE          gui=bold  
            \   ctermfg=red         ctermbg=NONE        cterm=bold

hi Identifier   guifg=#66ff77       guibg=NONE          gui=NONE
            \   ctermfg=yellow      ctermbg=NONE        cterm=NONE

hi Statement    guifg=#66ff77       guibg=NONE          gui=bold
...
hi Type         guifg=#40d9ff       guibg=NONE          gui=bold
...
" Specific fixes
hi cssImportant	guifg=#ffffff       guibg=#ff0000       gui=bold
            \   ctermfg=black       ctermbg=yellow      cterm=bold
" }}}
